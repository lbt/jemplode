/* AbstractOneParameterFunction - Decompiled by JODE
...
public abstract class AbstractOneParameterFunction implements IPredicate
{
    ...
    public AbstractOneParameterFunction(String _functionName,
					IPredicate _parameter) {
    ...
    protected abstract String evaluate(IFIDNode ifidnode, String string);
	...
	return (myFunctionName + "("
		+ (myParameter == null ? "" : myParameter.toString()) + ")");
    }
}
