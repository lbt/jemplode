...
public class BasicTagPlaylistSoupLayer extends AbstractTagPlaylistSoupLayer {
	public BasicTagPlaylistSoupLayer(String _tagName, int _containedType, String _sortTag) {
		super(_tagName, _containedType, _sortTag);
	}
	
	public BasicTagPlaylistSoupLayer(NodeTag _tag, int _containedType, NodeTag _sortTag) {
