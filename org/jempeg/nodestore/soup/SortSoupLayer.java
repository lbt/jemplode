...
public class SortSoupLayer implements ISoupLayer {
	...
	public SortSoupLayer(NodeTag _sortTag) {
		this(SoupLayerFactory.DEFAULT_CONTAINED_TYPE, _sortTag);
	}

	public SortSoupLayer(int _containedType, String _sortTag) throws ParseException {
	...
	public boolean qualifies(IFIDNode _node) {
		boolean qualifies = _node.isIdentified() && !_node.isTransient() && !_node.isMarkedForDeletion();
		return qualifies;
	}
