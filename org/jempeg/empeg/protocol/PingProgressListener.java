/* PingProgressListener - Decompiled by JODE
...
public class PingProgressListener implements ISimpleProgressListener
{
    ...
    public PingProgressListener
	(EmpegProtocolClient _protocolClient,
	 ISimpleProgressListener _proxiedProgressListener) {
    ...
    public void progressReported(String _description, long _current,
				 long _maximum) {
	myPinger.pingIfNecessary();
	myProxiedProgressListener.progressReported(_description, _current,
						   _maximum);
    }
}
