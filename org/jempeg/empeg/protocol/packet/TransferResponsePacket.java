/* TransferResponsePacket - Decompiled by JODE
...
public class TransferResponsePacket extends AbstractEmpegResponsePacket
{
    ...
    private UINT32 myChunkSize = new UINT32();
	...
	int bufferSize
	    = (getHeader().getDataSize()
	       - (myResult.getLength() + myFileID.getLength()
		  + myChunkOffset.getLength() + myChunkSize.getLength()));
	myBuffer.read(bufferSize, _is);
    }
    
    public String toString() {
	return ("[TransferResponsePacket: header = " + getHeader()
