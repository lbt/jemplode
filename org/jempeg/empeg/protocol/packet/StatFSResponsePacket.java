...
public class StatFSResponsePacket extends AbstractEmpegResponsePacket {
	...
	public String toString() {
		return "[StatFSResponsePacket: header = " + getHeader() + 
			"; drive0Size = " + myDrive0Size + "; drive0Space = " + myDrive0Space + "; drive0BlockSize = " + myDrive0BlockSize + 
			"; drive1Size = " + myDrive1Size + "; drive1Space = " + myDrive1Space + "; drive1BlockSize = " + myDrive1BlockSize + 
			"; crc = " + getCRC() + "]";
	}
}
