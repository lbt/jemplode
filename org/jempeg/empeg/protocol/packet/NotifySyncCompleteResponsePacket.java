...
*/
public class NotifySyncCompleteResponsePacket extends AbstractEmpegResponsePacket {
	...
	public String toString() {
		return "[NotifySyncCompleteResponsePacket: header = " + getHeader() + "; result = " + myResult + "; crc = " + getCRC() + "]";
	}
}
