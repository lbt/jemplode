...
public class CommandRequestPacket extends AbstractEmpegRequestPacket {
	...
	public CommandRequestPacket(UINT32 _packetID, UINT32 _command, UINT32 _parameter0, UINT32 _parameter1, String _parameter2) {
    this(_packetID, _command, _parameter0, _parameter1, new CharArray(_parameter2, 256));
  }

	public CommandRequestPacket(UINT32 _packetID, UINT32 _command, UINT32 _parameter0, UINT32 _parameter1, CharArray _parameter2) {
		super(_packetID);
		myCommand = _command;
	...
	protected int getDataSize() {
		return (myCommand.getLength() + myParameter0.getLength() + myParameter1.getLength() + myParameter2.getLength());
	}
	
	protected short getOpcode() {
		return PacketConstants.OP_COMMAND;
	}
	...
	public String toString() {
		return "[CommandRequestPacket: header = " + getHeader() + "; command = " + myCommand + "; param0 = " + myParameter0 + "; param1 = " + myParameter1 + "; param2 = " + myParameter2 + "; crc = " + getCRC() + "]";
	}
}
