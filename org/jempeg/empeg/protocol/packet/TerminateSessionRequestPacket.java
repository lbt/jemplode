/* TerminateSessionRequestPacket - Decompiled by JODE
...
public class TerminateSessionRequestPacket extends AbstractEmpegRequestPacket
{
    ...
    public TerminateSessionRequestPacket(UINT32 _packetID,
	...
	return ("[TerminateSessionRequestPacket: header = " + getHeader()
