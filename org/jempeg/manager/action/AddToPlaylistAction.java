...
public class AddToPlaylistAction extends AbstractAction {
  ...
  public AddToPlaylistAction(ApplicationContext _context, boolean _allowPlaylistSelection) {
    myContext = _context;
  ...
  public void actionPerformed(ActionEvent _event) {
    ...
    if (selection != null && size > 0) {
      SelectPlaylistDialog selectPlaylistDialog = new SelectPlaylistDialog(myContext.getFrame(), myContext, ResourceBundleUtils.getUIString("addToPlaylist.frameTitle"));
      ...
      if (selectedPlaylist != null) {
        ...
        for (int i = 0; i < size; i ++ ) {
          ...
          if (node instanceof FIDPlaylist && !myAllowPlaylistSelection) {
            selectedPlaylist.addPlaylistChildren((FIDPlaylist)node, cache);
          }
          else {
