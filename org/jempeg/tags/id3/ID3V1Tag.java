...
public class ID3V1Tag {
	...
	private CharArray mySignature = new CharArray(3); // Should be 'TAG'
	private CharArray myTitle = new CharArray(ID3V1Tag.ID3V1_FIELD_LENGTH);
	private CharArray myArtist = new CharArray(ID3V1Tag.ID3V1_FIELD_LENGTH);
	private CharArray myAlbum = new CharArray(ID3V1Tag.ID3V1_FIELD_LENGTH);
	private CharArray myYear = new CharArray(4);
	private CharArray myComment = new CharArray(ID3V1Tag.ID3V1_FIELD_LENGTH); // Also includes track number as last byte.
	...
	public int getLength() {
		return mySignature.getLength() + myTitle.getLength() + myArtist.getLength() + myAlbum.getLength() + myYear.getLength() + myComment.getLength() + myGenre.getLength();
	}
