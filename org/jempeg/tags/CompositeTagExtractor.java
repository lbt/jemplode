/* CompositeTagExtractor - Decompiled by JODE
...
public class CompositeTagExtractor implements ITagExtractor
{
    ...
    public CompositeTagExtractor(Vector _tagExtractors,
				 boolean _allowUnknownTypes) {
	...
	while (!tagsExtracted && tagExtractorsEnum.hasMoreElements()) {
	    PropertiesTagExtractorListener ptel
    ...
    private void refireExtractedTags(PropertiesTagExtractorListener _source,
				     ITagExtractorListener _target) {
