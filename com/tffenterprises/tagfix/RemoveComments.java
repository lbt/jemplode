/* RemoveComments - Decompiled by JODE
...
public class RemoveComments implements FileAction
{
    public void finish() {
	/* empty */
    }
	...
	if (f.isFile() && f.getName().indexOf(".mp3") != -1) {
		...
		for (Frame frame = tag.getFrameOfType("COMM"); frame != null;
		     frame = tag.getFrameOfType("COMM"))
