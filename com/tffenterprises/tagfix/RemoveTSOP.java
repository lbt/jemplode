...
public class RemoveTSOP implements FileAction
{
    public void finish() {
	/* empty */
    }
	...
	if (f.isFile() && f.getName().indexOf(".mp3") != -1) {
		...
		for (Frame frame = tag.getFrameOfType("TSOP"); frame != null;
		     frame = tag.getFrameOfType("TSOP"))
