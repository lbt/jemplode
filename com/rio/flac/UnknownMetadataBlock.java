/* UnknownMetadataBlock - Decompiled by JODE
...
public class UnknownMetadataBlock implements IFlacMetadataBlock
{
    private FlacMetadataBlockHeader myHeader;
    
    public UnknownMetadataBlock(FlacMetadataBlockHeader _header) {
	myHeader = _header;
    }
