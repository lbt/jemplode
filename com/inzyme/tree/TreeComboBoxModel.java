...
public class TreeComboBoxModel implements ComboBoxModel {
  ...
  protected Object getElementAt(TreeNode _startingNode, int _curIndex, int _desiredIndex) {
    Object obj = null;
    int index = 0;
    ...
    for (int i = 0; obj == null && i < childCount; i ++ ) {
      ...
      else if (isOpen(childNode)) {
        Object o = getElementAt(childNode, _curIndex + index, _desiredIndex);
  ...
  public static void main(String[] _args) {
    ...
    final TreeComboBoxModel comboBoxModel = new TreeComboBoxModel(node1, true);
