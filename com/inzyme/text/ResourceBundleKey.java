...
public class ResourceBundleKey {
	...
	public ResourceBundleKey(String _baseNameKey, String _key, Object[] _values) {
		this(_baseNameKey, _key, _values, _key);
	}
	
	public ResourceBundleKey(String _baseNameKey, String _key, Object[] _values, String _default) {
	...
	public ResourceBundleKey(String _baseNameKey, String _key, String _default) {
    ...
    String value;
      ...
      value = getString(myValues);
			...
			try {
				...
				Debug.println(Debug.WARNING, "Missing entry for '" + myKey + "' in resource bundle '" + baseName + " (" + myBaseNameKey + ")'.");
				value = myDefault;
			}
			catch (Throwable e) {
