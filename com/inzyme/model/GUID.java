...
public class GUID
{
    public UINT32 myData1;
    public UINT16 myData2;
    public UINT16 myData3;
    public CharArray myData4;
    
    public GUID() {
	myData1 = new UINT32();
	myData2 = new UINT16();
	myData3 = new UINT16();
	myData4 = new CharArray(8);
    }
    
    public GUID(long l, int w1, int w2, int b1, int b2, int b3, int b4, int b5,
	...
	myData2.setValue(w1);
	myData3.setValue(w2);
	myData4.setValue(new byte[] { (byte) b1, (byte) b2, (byte) b3,
	...
	if (equals) {
	    ...
	    equals = (myData1.equals(otherGuid.myData1)
		      && myData2.equals(otherGuid.myData2)
		      && myData3.equals(otherGuid.myData3)
		      && myData4.equals(otherGuid.myData4));
	}
	return equals;
    }
    
    public int hashCode() {
	return (myData1.hashCode() + myData2.hashCode() + myData3.hashCode()
		+ myData4.hashCode());
    }
	...
	st.append("-");
	for (int i = 0; i <= 1; i++)
	    StringUtils.padAppend(st,
				  (long) TypeConversionUtils
					     .toUnsigned8(bytez[i]),
				  2, 16);
	st.append("-");
