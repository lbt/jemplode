/* LittleEndianByteToUINT32Buffer - Decompiled by JODE
...
public class LittleEndianByteToUINT32Buffer
{
	...
	long value = LittleEndianUtils.toUnsigned32(myBuffer[newindex],
						    myBuffer[newindex + 1],
						    myBuffer[newindex + 2],
						    myBuffer[newindex + 3]);
	return value;
	...
	int newindex = _index * 4;
	int value = LittleEndianUtils.toSigned32(myBuffer[newindex],
						 myBuffer[newindex + 1],
						 myBuffer[newindex + 2],
						 myBuffer[newindex + 3]);
	return value;
	...
	myBuffer[newindex] = (byte) (int) (_value & 0xffL);
	myBuffer[newindex + 1] = (byte) (int) (_value >> 8 & 0xffL);
	myBuffer[newindex + 2] = (byte) (int) (_value >> 16 & 0xffL);
	myBuffer[newindex + 3] = (byte) (int) (_value >> 32 & 0xffL);
    }
