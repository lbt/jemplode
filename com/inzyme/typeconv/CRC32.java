...
public class CRC32 implements Checksum {
	...
	public static final int[] crc32tab = { /* CRC polynomial 0xedb88320 */
	...
	public final void update(int _value) {
		// TODO: Should we be using the toUnsigned8 version or not?? <begin pants enshitment>
//		int value = LittleEndianUtils.toUnsigned8(_value);
		myValue = (crc32tab[(myValue ^ _value) & 0xff] ^ ((myValue >> 8) & 0x00ffffff));
	}
	...
	public final long getValue() {
		...
		*/
	public final UINT16 getEmpegValue() {
