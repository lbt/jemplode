...
public class Page
{
	...
	long foo = (long) (header_base[header + 13] & 0xff);
	...
	for (int i = 0; i < body_len; i++)
	    crc_reg
		= crc_reg << 8 ^ crc_lookup[(crc_reg >>> 24 & 0xff
